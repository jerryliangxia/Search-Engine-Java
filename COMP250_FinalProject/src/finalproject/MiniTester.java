...
public class MiniTester{
 ...
 private int testNumVertices(int testIdx)	// success
 {
 ...
 private int testVisited(int testIdx)	// success
 {
 ...
 private int testAssignRanks(int testIdx)	// success
 {
 ...
 private int testComputeRanks(int testIdx)	// success
 {
